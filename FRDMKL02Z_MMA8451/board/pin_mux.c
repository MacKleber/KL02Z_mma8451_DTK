...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '7', peripheral: I2C0, signal: SCL, pin_signal: EXTAL0/PTA3/I2C0_SCL/I2C1_SDA, identifier: ''}
  - {pin_num: '8', peripheral: I2C0, signal: SDA, pin_signal: XTAL0/PTA4/I2C0_SDA/I2C1_SCL}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_i2c0pins(void)
{
    ...
    /* PORTA3 (pin 7) is configured as I2C0_SCL */
    PORT_SetPinMux(PORTA, 3U, kPORT_MuxAlt2);

    /* PORTA4 (pin 8) is configured as I2C0_SDA */
    PORT_SetPinMux(BOARD_I2C0PINS_XTAL0_PORT, BOARD_I2C0PINS_XTAL0_PIN, kPORT_MuxAlt2);
}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : MMA8451_initspins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void MMA8451_initspins(void)
{
    /* Port A Clock Gate Control: Clock enabled */
    CLOCK_EnableClock(kCLOCK_PortA);
    ...
    GPIO_PinInit(MMA8451_INITSPINS_ACCEL_IRQ_8_GPIO, MMA8451_INITSPINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8_config);
    ...
    PORT_SetPinConfig(MMA8451_INITSPINS_ACCEL_IRQ_8_PORT, MMA8451_INITSPINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8);
}
...
- pin_list:
  ...
  - {pin_num: '2', peripheral: GPIOB, signal: 'GPIO, 7', pin_signal: PTB7/IRQ_3/TPM1_CH0, direction: OUTPUT, gpio_init_state: 'false'}
  - {pin_num: '13', peripheral: GPIOB, signal: 'GPIO, 10', pin_signal: ADC0_SE9/PTB10/TPM0_CH1, direction: OUTPUT, gpio_init_state: 'false'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
