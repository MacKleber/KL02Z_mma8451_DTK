 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
LEDS_initpin:
- options: {callFromInitBoot: 'true', prefix: LEDS_INITPIN_, coreID: core0, enableClock: 'true'}
- pin_list:
...
void LEDS_initpin(void)
{
    ...
    GPIO_PinInit(LEDS_INITPIN_LED_RED_GPIO, LEDS_INITPIN_LED_RED_PIN, &LED_RED_config);
    ...
    GPIO_PinInit(LEDS_INITPIN_LED_GREEN_GPIO, LEDS_INITPIN_LED_GREEN_PIN, &LED_GREEN_config);
    ...
    GPIO_PinInit(LEDS_INITPIN_LED_BLUE_GPIO, LEDS_INITPIN_LED_BLUE_PIN, &LED_BLUE_config);

    /* PORTB10 (pin 13) is configured as PTB10 */
    PORT_SetPinMux(LEDS_INITPIN_LED_BLUE_PORT, LEDS_INITPIN_LED_BLUE_PIN, kPORT_MuxAsGpio);

    /* PORTB6 (pin 1) is configured as PTB6 */
    PORT_SetPinMux(LEDS_INITPIN_LED_RED_PORT, LEDS_INITPIN_LED_RED_PIN, kPORT_MuxAsGpio);

    /* PORTB7 (pin 2) is configured as PTB7 */
    PORT_SetPinMux(LEDS_INITPIN_LED_GREEN_PORT, LEDS_INITPIN_LED_GREEN_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
